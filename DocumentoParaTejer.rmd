...
fwrite(datos_limpios, file = "sep2022/datosLimpios.CSV")
```

```{r}
kable(
  head(datos_limpios[, c("id_persona", "area", "sexo", "edad",
                         "jefe_hogar", "estado_civil", "etnia")]),
  caption = "Datos Listos para Modelar 1",
  escape = F,
  booktab = T,
  align = "c",
  row.names = T)
...
kable(
  head(datos_limpios[, c("educacion", "salario", "contrato",
                         "cotiza_pension", "exp_cotiza", "exp_potencial")]),
  caption = "Datos Listos para Modelar 2",
  escape = F,
  booktab = T,
  align = "c",
  row.names = T)
...
Realizada la unión, en las tablas 3 y 4 se puede visualizar la estructura final de los datos que se ingresarán al modelo.